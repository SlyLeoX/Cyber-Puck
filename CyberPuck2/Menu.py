...
class Menu:
    ...
    def __init__(self, application, *groups):
        ...
        items = (('Story', application.story), ('Versus', application.versus), ('Collection', application.collection), ('Settings', application.settings), ('Credit', application.credit), ['Quit', application.quit])
        x = 1366 / 2
        y = 100
        self.buttons = []
