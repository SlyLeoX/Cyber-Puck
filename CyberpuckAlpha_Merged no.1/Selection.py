...
class Selection(Application):
    def __init__(self, game):
        ...
        self.perso11x, self.perso11y = self.midw + 300, self.midh - 100
        self.perso21x, self.perso21y = self.midw + 300, self.midh
        self.perso31x, self.perso31y = self.midw + 300, self.midh + 100
        self.perso41x, self.perso41y = self.midw + 300, self.midh + 200
        self.perso51x, self.perso51y = self.midw + 300, self.midh + 300
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text_3("P2 character", 40, self.midw + 300, self.midh - 200)
            ...
            self.game.draw_text("Mephiles", 40, self.perso40x, self.perso40y)
            self.game.draw_text("Leowenex", 40, self.perso50x, self.perso50y)
            ...
            self.game.draw_text("Mephiles", 40, self.perso41x, self.perso41y)
            self.game.draw_text("Leowenex", 40, self.perso51x, self.perso51y)
    ...
    def check_input(self):
        ...
        if pygame.key.get_pressed()[pygame.K_e]:
            if self.state == 'Sanic':
                ...
                self.player_parameters[1][1] = "Harry"
            elif self.state == 'Mephiles':
                self.player_parameters[1][1] = "Mephiles"
            elif self.state == 'Leowenex':
                self.player_parameters[1][1] = "Leowenex"
            self.run_display = False
    ...
    def check_input2(self):
        ...
        if self.game.START_KEY:
            if self.state == 'Sanic':
                ...
                self.player_parameters[0][1] = "Harry"
            elif self.state == 'Mephiles':
                self.player_parameters[0][1] = "Mephiles"
            elif self.state == 'Leowenex':
                self.player_parameters[0][1] = "Leowenex"
            self.run_display = False

    def check_input3(self):
        if self.game.START_KEY or pygame.key.get_pressed()[pygame.K_e]:
            if self.state == 'Play':
