    ...
    def check_input(self):
        ...
        if self.game.TAB_KEY:
            ...
            if self.state == 'Sanic':
                ...
                self.game.player_parameters[0][1] = "Mephiles"
            elif self.state == 'Leowenex':
                self.game.player_parameters[0][1] = "Leowenex"
            self.run_display = False
    ...
    def check_input2(self):
        ...
        if self.game.START_KEY:
            ...
            if self.state == 'Sanic':
                ...
                self.game.player_parameters[1][1] = "Mephiles"
            elif self.state == 'Leowenex':
                self.game.player_parameters[1][1] = "Leowenex"
            self.run_display = False
